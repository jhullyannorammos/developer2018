    ...
    $(document).ready(function() {
		$("#save-person").click(function() {
			    ...
			    if ($("#prn").val() == ''){
				   ...
				   $("#dialog").text("O nome deve ser preenchido.");
				   $("#prn").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#prn").css("border", "1px solid #008000");
				}

				if ($("#sbn").val() == ''){
				   $("#dialog").addClass('alert alert-danger alert-dismissable');
				   $("#dialog").text("O sobrenome deve ser preenchido.");
				   $("#sbn").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#sbn").css("border", "1px solid #008000");
				}

				if ($("#dtn").val() == ''){
				   $("#dialog").addClass('alert alert-danger alert-dismissable');
				   $("#dialog").text("A data de nascimento deve ser preenchido.");
				   $("#dtn").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#dtn").css("border", "1px solid #008000");
				}

				if ($("#rgg").val() == ''){
				   $("#dialog").addClass('alert alert-danger alert-dismissable');
				   $("#dialog").text("O RG deve ser preenchido.");
				   $("#rgg").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#rgg").css("border", "1px solid #008000");
				}

				if ($("#cpf").val() == ''){
				   $("#dialog").addClass('alert alert-danger alert-dismissable');
				   $("#dialog").text("O CPF deve ser preenchido.");
				   $("#cpf").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#cpf").css("border", "1px solid #008000");
				}

				if ($("#cnh").val() == ''){
				   $("#dialog").addClass('alert alert-danger alert-dismissable');
				   $("#dialog").text("A CNH deve ser preenchido.");
				   $("#cnh").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#cnh").css("border", "1px solid #008000");
				}

				if ($("#eml").val() == ''){
				   $("#dialog").addClass('alert alert-danger alert-dismissable');
				   $("#dialog").text("O e-mail deve ser preenchido.");
				   $("#eml").css("border", "1px solid #FF0000");
				   return false;
				}else{
				   $("#eml").css("border", "1px solid #008000");
				}
                */
				var prn = $('#prn').val();
				var sgn = $('#sgn').val();
				...
				$.ajax({
				    ...
				    success: function (data) {
					    ...
					    $("#dialog").text("Mensagem : " + data + " adicionado com sucesso.");
				   }
				});
							...
							<table class="table table-bordered table-hover table-striped tablesorter">
								...
								<tbody>
									<tr class="active">
										...
										<td><input id="umn" class="form-control" name="umn" /></td>
									</tr>
								</tbody>
							</table>
